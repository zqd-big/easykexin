window.QUESTIONS = [
  ...
  },
  {
    ...
    "answer_code": "首次传原串，后续传 NULL，循环收集 token。",
  ...
  },
  {
    ...
    "answer_code": "维护 head/tail/count，入队写 tail，出队读 head。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "answer_code": "左括号入栈，右括号匹配栈顶，最后栈空即合法。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "answer_code": "三指针 prev/cur/next 迭代反转。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "answer_code": "if(!x) return; visit(x); dfs(x->left); dfs(x->right);",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "expected_output": "true",
    "starter_code": "int connected(...) { /* TODO */ }",
    "answer_code": "邻接表 + 队列 + visited，首次到达 t 即返回 true。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "expected_output": "2",
    "starter_code": "int min_len(...) { /* TODO */ }",
    "answer_code": "右指针扩张，满足后左指针收缩更新最优长度。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "answer_code": "fast 扫描，slow 写入新位置。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "input_example": "a=[2,4,5,1], query=[1,3]",
    "expected_output": "10",
    "starter_code": "void build(...){/*TODO*/}\nint sum(...){/*TODO*/}",
    "answer_code": "pre[i+1]=pre[i]+a[i]，区间和=pre[r+1]-pre[l]。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "answer_code": "return n<=1 ? 1 : (long long)n * f(n-1);",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "starter_code": "void dfs(...) { /* TODO: used[] + path */ }",
    "answer_code": "做选择 -> 递归 -> 撤销选择。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "expected_output": "[1,2,4,5]",
    "starter_code": "void merge_sort(...) { /* TODO */ }",
    "answer_code": "递归分两半，merge 阶段双指针合并。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "expected_output": "2",
    "starter_code": "int lower_bound(...) { /* TODO */ }",
    "answer_code": "[l,r) 模板：while(l<r){...}",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "expected_output": "2",
    "starter_code": "int solve(...) { /* TODO */ }",
    "answer_code": "按结束时间升序排序，贪心选择可接上的区间。",
    "explanation": "目标是在 1~3 分钟内回忆并写出可运行模板。",
    "common_mistakes": [
      "边界条件遗漏",
      "状态更新顺序错误"
  ...
  },
  {
    ...
    "starter_code": "VosVector *vec = VOS_VectorCreate(sizeof(int), NULL);\n/* TODO */",
    "answer_code": "for (int i = 0; i < 3; ++i) VOS_VectorPushBack(vec, &arr[i]);",
  ...
  },
  {
    ...
    "answer_code": "遍历时先取 next，再按条件删除当前节点。",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
  ...
  },
  {
    ...
    "answer_code": "int *p=(int*)VOS_MapGet(map,key); if(!p){int z=0; VOS_MapPut(map,key,&z);}",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
  ...
  },
  {
    ...
    "answer_code": "if (a->left != b->left) return b->left - a->left;\nif (a->vm != b->vm) return a->vm - b->vm;\nreturn a->id - b->id;",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
  ...
  },
  {
    ...
    "answer_code": "若 VOS_HashFind 为 NULL 则插入并写入结果。",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
  ...
  },
  {
    ...
    "answer_code": "cmp 返回三值比较；调用 VOS_VectorSort(vec, cmp)。",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
  ...
  },
  {
    ...
    "answer_code": "top 查看后满足条件则 pop，再 push 更新后的机器状态。",
    "explanation": "重点训练 VOS 容器接口调用顺序和内存生命周期。",
    "common_mistakes": [
      "传入悬挂指针",
      "忘记销毁或释放资源"
